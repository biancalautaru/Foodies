...
public final class DataSeeder {
    ...
    public static void seed(IUserService userService, IRestaurantService restaurantService,
                            IMenuService menuService, IOrderService orderService) {
        ...
        OrderItems orderItems = seedMenus(restaurantService, menuService, restaurants);
        seedOrders(orderService, customers, orderItems);
    }

    private static void seedTestAccount(IUserService userService) {
    ...
    private static void addDriverIfMissing(IUserService userService, Driver driver) {
    ...
    private static void addCustomerIfMissing(IUserService userService, Customer customer) {
    ...
    private static void addRestaurantIfMissing(IRestaurantService restaurantService, Set<String> existing, Restaurant restaurant) {
        if (!existing.contains(restaurant.getId()))
            restaurantService.addRestaurant(restaurant);
    }

    private static OrderItems seedMenus(IRestaurantService r, IMenuService menuService, Restaurants rs) {
        addItems(r, menuService, rs.restaurant1(),
        ...
        addItems(r, menuService, rs.restaurant2(),
            item1, item2, item3,
        ...
        addItems(r, menuService, rs.restaurant3(),
            item4, item5, item6,
        ...
        addItems(r, menuService, rs.restaurant4(),
            item7, item8, item9,
        ...
        addItems(r, menuService, rs.restaurant5(),
    ...
    private static void addItems(IRestaurantService svc, IMenuService menuService, Restaurant restaurant, MenuItem... items) {
        Set<String> existing = new HashSet<>();
        for (MenuItem existingItem : menuService.getMenu(restaurant.getId()))
